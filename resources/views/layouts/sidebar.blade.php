    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="#"><img src="{{ asset('/images/spos.png') }}" alt="Logo" srcset=""
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item has-sub {{ request()->is('kategori', 'produk') ? 'active' : '' }}">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="submenu-item {{ request()->is('produk') ? 'active' : '' }}">
                            <a href="{{ route('produk.index') }}" class="submenu-link">Produk</a>
                        </li>
                    </ul>
                </li>
                ...
                <li
                    ...
                    <ul class="submenu">
                        <li class="submenu-item {{ request()->is('pengeluaran') ? 'active' : '' }}">
                            <a href="{{ route('pengeluaran.index') }}" class="submenu-link">Pengeluaran</a>
                        </li>

                        <li class="submenu-item {{ request()->is('pembelian') ? 'active' : '' }}">
                            <a href="{{ route('pembelian.index') }}" class="submenu-link">Pembelian</a>
                        </li>

                        <li class="submenu-item {{ request()->is('penjualan') ? 'active' : '' }}">
                            <a href="{{ route('penjualan.index') }}" class="submenu-link">Penjualan</a>
                        </li>

                        <li class="submenu-item {{ request()->is('transaksi') ? 'active' : '' }}">
                            <a href="{{ route('transaksi.baru') }}" class="submenu-link">Transaksi</a>
                        </li>
