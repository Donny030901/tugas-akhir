                ...
                <div class="buttons">
                    <div class="btn-group">
                        ...
                        <button type="button" onclick="deleteSelected('{{ route('produk.delete_selected') }}')"
                            class="btn btn-danger rounded-pill"><i data-feather="trash"></i>
                            Hapus</button>
                        <button type="button" onclick="cetakBarcode('{{ route('produk.cetak_barcode') }}')"
                            class="btn btn-light rounded-pill"><i data-feather="menu"></i>
                    ...
                    <form action="" method="post" class="form-produk">
                        ...
                        <table class="table table-striped table-bordered">
                            <thead>
                                ...
                                <th>Diskon</th>
                                <th>Stok</th>
                                <th width="12%"><i data-feather="settings"></i></th>
